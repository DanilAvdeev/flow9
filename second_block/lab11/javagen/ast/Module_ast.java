...
final public class Module_ast {
	public static final String f_Str(Struct aexp_0) {
			...
			case 8/*Add*/: {
				...
				return (((("("+Module_ast.f_Str(l4_l))+"+")+Module_ast.f_Str(l5_r))+")");
			}
			case 105/*Sub*/: {
				...
				return (((("("+Module_ast.f_Str(l8_l))+"-")+Module_ast.f_Str(l9_r))+")");
			}
			case 38/*Mul*/: {
				...
				return (((("("+Module_ast.f_Str(l12_l))+"*")+Module_ast.f_Str(l13_r))+")");
			}
			case 16/*Div*/: {
				...
				return (((("("+Module_ast.f_Str(l16_l))+"/")+Module_ast.f_Str(l17_r))+")");
			}
			case 94/*Pow*/: {
	...
	public static final Struct f_Val(Struct aexp_0, Struct avariables) {
			...
			final Func3<Struct,Struct, Struct, Func2<Struct,Double, Double>> l0_apply_op = (Func3<Struct, Struct, Struct, Func2<Struct,Double, Double>>)(Struct al, Struct ar, Func2<Struct,Double, Double> aop) -> {
				final Struct l1_gsymswitch0 = Module_ast.f_Val(al, l1_variables);
				...
				case 103/*Some*/: {
					...
					final Struct l6_gsymswitch1 = Module_ast.f_Val(ar, l1_variables);
			...
			case 39/*Neg*/: {
				...
				final Struct l35_gsymswitch2 = Module_ast.f_Val(l34_e, avariables);
	...
	public static final Struct f_deriv(Struct aexp_0, String avar) {
			...
			case 8/*Add*/: {
				...
				final Struct l4_l = l1__tmp.f_left;
				final Struct l5_r = l1__tmp.f_right;
				return (new Struct_Add(Module_ast.f_deriv(l4_l, avar), Module_ast.f_deriv(l5_r, avar)));
			}
			case 105/*Sub*/: {
				final Struct_Sub l1__tmp = (Struct_Sub)l0__tmp;
				final Struct l6_l = l1__tmp.f_left;
				...
				final Struct l8_l = l1__tmp.f_left;
				final Struct l9_r = l1__tmp.f_right;
				return (new Struct_Sub(Module_ast.f_deriv(l8_l, avar), Module_ast.f_deriv(l9_r, avar)));
			}
			case 38/*Mul*/: {
				final Struct_Mul l1__tmp = (Struct_Mul)l0__tmp;
				final Struct l10_l = l1__tmp.f_left;
				...
				final Struct l12_l = l1__tmp.f_left;
				final Struct l13_r = l1__tmp.f_right;
				return (new Struct_Add((new Struct_Mul(Module_ast.f_deriv(l12_l, avar), l13_r)), (new Struct_Mul(Module_ast.f_deriv(l13_r, avar), l12_l))));
			}
			case 16/*Div*/: {
				final Struct_Div l1__tmp = (Struct_Div)l0__tmp;
				final Struct l14_l = l1__tmp.f_left;
				...
				final Struct l16_l = l1__tmp.f_left;
				final Struct l17_r = l1__tmp.f_right;
				return (new Struct_Div((new Struct_Sub((new Struct_Mul(Module_ast.f_deriv(l16_l, avar), l17_r)), (new Struct_Mul(Module_ast.f_deriv(l17_r, avar), l16_l)))), (new Struct_Pow(l17_r, (new Struct_Int(2.0))))));
			}
			case 94/*Pow*/: {
				final Struct_Pow l1__tmp = (Struct_Pow)l0__tmp;
				final Struct l18_l = l1__tmp.f_left;
				...
				final Struct l20_l = l1__tmp.f_left;
				final Struct l21_r = l1__tmp.f_right;
				return (new Struct_Mul((new Struct_Pow(l20_l, l21_r)), (new Struct_Div((new Struct_Mul(l21_r, Module_ast.f_deriv(l20_l, avar))), l20_l))));
			}
			case 39/*Neg*/: {
				final Struct_Neg l1__tmp = (Struct_Neg)l0__tmp;
				final Struct l22_e = l1__tmp.f_exp;
				final Struct l23_e = l1__tmp.f_exp;
				return (new Struct_Neg(Module_ast.f_deriv(l23_e, avar)));
			}
			case 22/*Int*/: {
				final Struct_Int l1__tmp = (Struct_Int)l0__tmp;
	...
	public static final Object f_main() {
			final String l0_exp_0 = Module_url_parameter.f_getUrlParameterDef("expression", "(-(-2))");
			final Struct l1_vars = Module_ast.f_getVariables();
			final Object l2_ast = Module_parsic.f_parsic(Module_ast.f_lingoGrammar(), l0_exp_0, Module_pegaction.g_defaultPegActions);
			Module_runtime.f_println(l2_ast);
			Module_runtime.f_println(Module_ast.f_Str(((Struct)l2_ast)));
			Module_runtime.f_println(Module_ast.f_Val(((Struct)l2_ast), l1_vars));
			Module_runtime.f_println(Module_ast.f_deriv(((Struct)l2_ast), "x"));
			Module_runtime.f_println(Module_ast.f_Str(Module_ast.f_deriv(((Struct)l2_ast), "x")));
			Module_runtime.f_println(Module_ast.f_Val(Module_ast.f_deriv(((Struct)l2_ast), "x"), l1_vars));
			final Struct l3_simplified = Module_ast.f_simplify(((Struct)l2_ast));
			Module_runtime.f_println("-------SIMPLIFY------");
			Module_runtime.f_println(l3_simplified);
			Module_runtime.f_println(Module_ast.f_Str(l3_simplified));
			Module_runtime.f_println(Module_ast.f_Val(l3_simplified, l1_vars));
			Module_runtime.f_println(Module_ast.f_deriv(l3_simplified, "x"));
			Module_runtime.f_println(Module_ast.f_Str(Module_ast.f_deriv(l3_simplified, "x")));
			Module_runtime.f_println(Module_ast.f_Val(Module_ast.f_deriv(l3_simplified, "x"), l1_vars));
	...
	public static final Struct f_simplify(Struct aexp_0) {
			...
			case 8/*Add*/: {
				...
				final Struct l4_l = l1__tmp.f_left;
				final Struct l5_r = l1__tmp.f_right;
				final Struct l6_left = Module_ast.f_simplify(l4_l);
				final Struct l7_right = Module_ast.f_simplify(l5_r);
			...
			case 105/*Sub*/: {
				...
				final Struct l14_l = l1__tmp.f_left;
				final Struct l15_r = l1__tmp.f_right;
				final Struct l16_left = Module_ast.f_simplify(l14_l);
				final Struct l17_right = Module_ast.f_simplify(l15_r);
			...
			case 38/*Mul*/: {
				...
				final Struct l26_left = Module_ast.f_simplify(l24_l);
				final Struct l27_right = Module_ast.f_simplify(l25_r);
			...
			case 16/*Div*/: {
				...
				final Struct l32_left = Module_ast.f_simplify(l30_l);
				final Struct l33_right = Module_ast.f_simplify(l31_r);
			...
			case 94/*Pow*/: {
				...
				final Struct l38_left = Module_ast.f_simplify(l36_l);
			...
			case 39/*Neg*/: {
				...
				final Struct l41_num = Module_ast.f_simplify(l40_e);
